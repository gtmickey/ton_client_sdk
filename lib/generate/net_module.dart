...
class NetModule extends _TonSdkModule {
  ...
  Future<ResultOfBatchQuery> batch_query(ParamsOfBatchQuery params) async {
    final res =
        await _tonCore.request('net.batch_query', params.toString());
  ...
  Future<ResultOfSubscribeCollection> subscribe_collection(
      ParamsOfSubscribeCollection params) async {
    final res = await _tonCore.request(
        'net.subscribe_collection', params.toString());
  ...
  Future<ResultOfSubscribeCollection> subscribe(
      ParamsOfSubscribe params) async {
    final res = await _tonCore.request(
        'net.subscribe', params.toString());
    return ResultOfSubscribeCollection.fromMap(res);
  }
  ...
  Future<void> resume() async {
    await _tonCore.request('net.resume', null);
  }
  ...
  Future<ResultOfFindLastShardBlock> find_last_shard_block(
    ...
    final res = await _tonCore.request(
        'net.find_last_shard_block', params.toString());
  ...
  Future<ResultOfGetEndpoints> get_endpoints() async {
    final res = await _tonCore.request('net.get_endpoints', null);
  ...
  Future<ResultOfQueryTransactionTree> query_transaction_tree(
    ...
    final res = await _tonCore.request(
        'net.query_transaction_tree', params.toString());
  ...
  Future<ResultOfGetSignatureId> get_signature_id() async {
    final res = await _tonCore.request('net.get_signature_id', null);
